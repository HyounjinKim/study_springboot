...
import com.khj.restapi03.exception.ErrorCode;
import com.khj.restapi03.exception.UsersException;
...
//        return ResponseEntity.status(HttpStatus.OK).body(list);
    ...
    @PostMapping()
    public ResponseEntity<User> addUsers(@RequestBody @Valid UserDto userDto){
