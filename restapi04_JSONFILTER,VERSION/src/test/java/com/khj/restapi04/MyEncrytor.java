...
public class MyEncrytor {
    ...
    private String password = "mh1234";
    ...
    void name() {
        ...
        String content = "jdbc:mysql://localhost:3306/khj?useSSL=false&allowPublicKeyRetrieval=true&characterEncoding=UTF-8&serverTimezone=UTC";
